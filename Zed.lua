...
local UPDATE_SCRIPT_NAME = "Pow3R"
local UPDATE_HOST = "raw.github.com"
local UPDATE_PATH = "/MadJoee/BoL/master/Zed.lua"
	...
	function update()
		if ServerData ~= nil then
			...
			if ServerVersion ~= nil and tonumber(ServerVersion) ~= nil and tonumber(ServerVersion) > tonumber(version) then
				DownloadFile(UPDATE_URL.."?nocache"..myHero.charName..os.clock(), UPDATE_FILE_PATH, function () print("<font color=\"#FF0000\"><b>"..UPDATE_SCRIPT_NAME..":</b> successfully updated. Reload (x2 F9) Please. ("..version.." => "..ServerVersion..")</font>") end)     
...
function AfterDownload()
	...
	if DOWNLOAD_COUNT == 0 then
		...
		print("<b><font color=\"#6699FF\">Required libraries downloaded successfully, please reload (x2 F9).</font>")
	end
end
...
local WRANGE = 700+400
local ERANGE = 290
local RRANGE = 625+300


function OnLoad()
Menu()
    print("<b><font color=\"#6699FF\">Zed by Pow3R : Loaded</font>")
		print("<b><font color=\"#6699FF\">--------------------------------</font>")
		print("<b><font color=\"#6699FF\">-----Zed: Good Luck-----</font>")
...
function OnDraw()
     if (Configzedex.circle.circleq) then
		 ...
		 DrawCircle(myHero.x, myHero.y, myHero.z, 700, 0xFF00FF)
		 end
